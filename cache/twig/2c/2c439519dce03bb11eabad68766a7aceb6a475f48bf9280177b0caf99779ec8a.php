...
class __TwigTemplate_d98addb57b7b0faa507202976099487a70f2a774d05f596911cb5129f887c031 extends Twig_Template
{
    ...
    {
        return new Twig_Source("{% for message in grav.messages.fetch %}<div class=\"alert-{{ message.scope|e }} alert\">{{ message.message|raw }}</div>{% endfor %}", "__string_template__8a0a059708264894c19bc7c915c8bb47ba6967922908519c6ac5663e27f196c1", "");
    }
}
