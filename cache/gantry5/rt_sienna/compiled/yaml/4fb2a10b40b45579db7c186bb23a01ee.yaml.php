...
return [
    ...
    'filename' => '/var/www/html/user/data/gantry5/themes/rt_sienna/config/_offline/index.yaml',
    'modified' => 1517038498,
    'data' => [
        'name' => '_offline',
        ...
        'particles' => [
            'messages' => [
                'system-messages-5196' => 'System Messages'
            ],
            'logo' => [
                'logo-5992' => 'Logo'
            ],
            ...
            'simplecontent' => [
                'simplecontent-3880' => 'Simple Content'
            ],
            'content' => [
                'system-content-1047' => 'Page Content'
            ]
        ],
        'inherit' => [
