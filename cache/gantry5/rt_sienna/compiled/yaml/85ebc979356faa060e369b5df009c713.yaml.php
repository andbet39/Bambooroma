...
return [
    ...
    'filename' => '/var/www/html/user/data/gantry5/themes/rt_sienna/config/layouts_-_right_sidebar/layout.yaml',
    'modified' => 1517038322,
    'data' => [
        'version' => 2,
        'preset' => [
        ...
        'content' => [
            ...
            'simplecontent-6840' => [
                'title' => 'Right Sidebar Example',
                'attributes' => [
                    'items' => [
                        0 => [
                            'layout' => 'header',
                            'created_date' => '',
                            'content_title' => 'Right Sidebar Example',
                            'author' => '',
...
<p class="nomarginbottom"> A right column layout example. The sidebar is independent from the Mainbody so can have multiple rows and columns, separate from the Mainbody area.</p>'
            ...
            'custom-5002' => [
                ...
                'attributes' => [
                    'html' => '<h3 class="g-title">Flexible Layouts</h3>
